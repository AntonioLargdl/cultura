...
import comision from '../../../assets/creativa.webp'
import comisionWhite from '../../../assets/creativa_white.webp'
import { ColorModeContext } from "../../../contexts/color-mode";
import { DarkModeOutlined, LightModeOutlined } from "@mui/icons-material";

export const HeaderTalento: React.FC<RefineThemedLayoutV2HeaderProps> = ({ sticky = true,}) => {
    ...
    <AppBar position="fixed" sx={{background:bgcolor ,boxShadow:'none', color:color, padding:"20px 0"}}>
      <Toolbar>
        <Stack direction="row" width="100%" alignItems="center" >
            <Link to="/creativa">
                <img src={logo} alt="comision" className="w-20"/>
            </Link>
          <Stack
            direction="row"
            width="100%"
