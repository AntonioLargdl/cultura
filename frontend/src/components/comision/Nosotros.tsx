  ...
  return (
    <section className={`${styles.paddings} background-cfm min-h-screen flex relative`}>
      ...
      <div className='z-10'>
        ...
        />
          <TypingText title={`| ${t("pages.comision.about.title")}`} textStyles="text-center" />
          <motion.p
          ...
          >
            <span className="font-semibold text-white">{t("pages.comision.about.description1")}</span>, {t("pages.comision.about.description2")}
            <br /><br />
            {t("pages.comision.about.description3")}
          </motion.p>
          <motion.img
