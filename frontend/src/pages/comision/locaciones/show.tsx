...
const LocacionUser = () => {
    ...
    return (
     <div>
        ...
        <HeaderLocaciones />
        {/* Contenido */}
        <div className="flex justify-between md:items-center md:flex-row flex-col mt-28 px-4">
            <div className="flex gap-2 items-center">
                <div className="flex items-center">
                    <Link to="/cfm/locaciones" className="flex items-center">
                        <div className="m-2 shadow-lg p-2 rounded-xl border-[1px]">
                            <FcUndo className="text-xl"/>
                        </div>
                    </Link>
                </div>
        ...
        <div className='m-2 flex gap-5 lg:flex-nowrap flex-wrap md:mb-0 mb-5 px-4'>
            {/* Imágenes */}
